	...
	implements LayoutManager 
{
	 ...
	 */
	public VerticalFlowLayout(int align, int halign)
	{
		this(align, halign, 5, 5, false);
	}
	...
	{
		this(align, CENTER, hgap, vgap, false);
	}
	 ...
	 * @param vgap the vertical gap variable
	 */
	public VerticalFlowLayout(int align, int halign, int hgap, int vgap)
	{
		this(align, halign, hgap, vgap, false);
	}
	 ...
	 * @param hgap the horizontal gap variable
	 * @param vgap the vertical gap variable
	 * @param maximise whether the layout is to be maximized
	 */
	public VerticalFlowLayout(int align, int hgap, int vgap, boolean maximise)
	{
		this(align, CENTER, hgap, vgap, maximise);
	}
	 ...
	 * @param maximise whether the layout is to be maximized
	 */
	public VerticalFlowLayout(int align, int halign, int hgap, int vgap, boolean maximise) 
	{
		...
		if (halign!=LEFT && halign!=CENTER && halign!=RIGHT)
			throw new IllegalArgumentException("illegal horizontal alignment value: "+halign);
		if (hgap<0)
	...
	private void moveComponents(Container target, int x, int y, int width, int height, int columnStart, int columnEnd) 
	{
		...
		for (int i=columnStart; i<columnEnd; i++) 
		{
			...
			if (m.isVisible()) 
			{
				switch (halign)
				{
					case LEFT:   m.setLocation(x, y); break;
					case CENTER: m.setLocation(x+(width-mbounds.width)/2, y); break;
					case RIGHT:  m.setLocation(x+width-mbounds.width, y); break;
				}
